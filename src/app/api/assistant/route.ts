...
חיובים חוזרים, התראות, תזכורות, דו"חות, הגדרות):

מעבר מתוכנה אחרת / ייבוא נתונים - המסך /migrate ("מעבר מתוכנה אחרת"). זו התשובה לכל
שאלה על ייבוא, מעבר, העברת היסטוריה או "יש לי קובץ עם הלקוחות שלי":
...
מסמכים", "עיצוב מסמכים" (תבנית לפי מקצוע, מבנה, רקע, צבע, גופן, מיקום לוגו - "שמור
עיצוב"), "הגדרות אימייל" (שליחה מ-Gmail האישי עם App Password, אחרת נשלח מכתובת
