...
<body style="margin:0;padding:0;background:#f7f2eb;font-family:Arial,sans-serif;">
  <div dir="rtl" style="max-width:600px;margin:0 auto;padding:24px;">
    ...
    <div style="background:#ffffff;border:1px solid #e8ddd0;border-radius:12px;padding:24px;margin-bottom:24px;">
      ...
      <p style="margin:0 0 12px 0;font-size:14px;color:#1f232b;">
        ביקשתם קישור כניסה לצפייה בכל החשבוניות שלכם.
      </p>
      <p style="margin:0;font-size:14px;color:#1f232b;">
        הקישור תקף ל-24 שעות ומשמש לכניסה חד-פעמית לסשן של 7 ימים.
      </p>
    </div>
    <div style="text-align:center;margin-bottom:24px;">
      <a href="${link}" style="display:inline-block;background:#d96a1d;background-image:linear-gradient(135deg,#d96a1d,#c45f1a);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:16px;font-weight:bold;">
        כניסה לפורטל ←
      </a>
    </div>
    <div style="text-align:center;margin-bottom:16px;">
      <p style="font-size:13px;color:#6b6560;margin:0 0 6px 0;">אם הכפתור לא נפתח, העתיקו את הקישור:</p>
      <p style="font-size:12px;color:#6b6560;margin:0;word-break:break-all;">
        <a href="${link}" style="color:#1f232b;">${link}</a>
      </p>
    </div>
    <p style="font-size:12px;color:#9a9086;text-align:center;">
