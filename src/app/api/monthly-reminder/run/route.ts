...
<body style="margin:0;padding:0;background:#f7f2eb;font-family:Arial,sans-serif;">
  <div dir="rtl" style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:#ffffff;border:1px solid #e8ddd0;border-radius:12px;padding:24px;margin-bottom:24px;">
      ...
      ${
        summary.openItems.length
          ? `<p style="margin:0 0 6px 0;font-size:14px;font-weight:bold;color:#1f232b;">מסמכים פתוחים שטרם הפכו לחשבונית:</p>
             <ul style="margin:0 0 16px 0;padding-inline-start:20px;font-size:14px;color:#1f232b;">${openRows}</ul>`
          : ""
      }
      ${
    ...
    <div style="text-align:center;margin-bottom:24px;">
      <a href="${escapeHtml(APP_URL)}/documents" style="display:inline-block;background:#d96a1d;background-image:linear-gradient(135deg,#d96a1d,#c45f1a);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:16px;font-weight:bold;">
        לצפייה במסמכים ←
      </a>
    </div>
    <p style="font-size:11px;color:#9a9086;text-align:center;">תזכורת חודשית אוטומטית. ניתן לכבות בהגדרות החשבון.</p>
  </div>
</body>
</html>`;
}
