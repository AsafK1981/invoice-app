...
<body style="margin:0;padding:0;background:#f7f2eb;font-family:Arial,sans-serif;">
  <div dir="rtl" style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="background:#ffffff;border:1px solid #e8ddd0;border-radius:12px;padding:24px;margin-bottom:24px;">
      <p style="margin:0 0 12px 0;font-size:15px;color:#1f232b;line-height:1.6;">הכנו מסמך שנראה שאתה מוציא כל חודש. הוא לא יופק בלי שתאשר.</p>
      <p style="margin:0;font-size:15px;font-weight:bold;color:#1f232b;">${escapeHtml(line)}</p>
    </div>
    <div style="text-align:center;margin-bottom:24px;">
      <a href="${escapeHtml(APP_URL)}/dashboard" style="display:inline-block;background:#d96a1d;background-image:linear-gradient(135deg,#d96a1d,#c45f1a);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:16px;font-weight:bold;">לאישור המסמך ←</a>
    </div>
    <p style="font-size:11px;color:#9a9086;text-align:center;">הצעה אוטומטית למסמך חוזר. ניתן לכבות בעמוד התזכורות.</p>
  </div>
</body>
</html>`,
    headers: {
