...
import { ArrowLeftRight, Gift, ShieldCheck } from "lucide-react";
...
/**
 * The feature cards moved to ./advantages.tsx on 2026-08-24 so /pricing can
 * render the exact same cards (same icon, same tone, same copy) instead of
 * its own washed-out, re-typed copy. Everything below still derives from that
 * one array - see the module docstring there.
 */
