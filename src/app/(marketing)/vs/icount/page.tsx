...
export const metadata = vsMetadata({
  path: "/vs/icount",
  title: "חשבונית ידידותית vs iCount: השוואת מחירים ופיצ׳רים (2026)",
  description:
    "השוואה הוגנת בין חשבונית ידידותית ל-iCount: מחירים, פיצ׳רים, יתרונות וחסרונות של כל צד. אצלנו חינם עכשיו בהשקה, ואח\"כ מחיר כניסה זול ושקוף.",
  keywords: [
    "iCount השוואה",
    "חלופה ל-iCount",
    "iCount alternative",
