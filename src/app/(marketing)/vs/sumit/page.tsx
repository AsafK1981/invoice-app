...
export const metadata = vsMetadata({
  path: "/vs/sumit",
  title: "חשבונית ידידותית vs SUMIT: השוואת מחירים ופיצ׳רים (2026)",
  description:
    "השוואה הוגנת בין חשבונית ידידותית ל-SUMIT: מסלול חינם, מחירים, פיצ׳רים ויתרונות של כל צד. אצלנו חינם עכשיו בהשקה, ואחר כך מהזול בקטגוריה.",
  keywords: [
    "SUMIT השוואה",
    "חלופה ל-SUMIT",
    "SUMIT alternative",
