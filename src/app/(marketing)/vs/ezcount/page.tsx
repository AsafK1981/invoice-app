...
export const metadata = vsMetadata({
  path: "/vs/ezcount",
  title: "חשבונית ידידותית vs EZcount: השוואת מחירים ופיצ׳רים (2026)",
  description:
    "השוואה הוגנת בין חשבונית ידידותית ל-EZcount (מבית Hyp): מחירים, פיצ׳רים ויתרונות של כל צד. אצלנו חינם עכשיו בהשקה, ואח\"כ מחיר כניסה תחרותי.",
  keywords: [
    "EZcount השוואה",
    "חלופה ל-EZcount",
    "EZcount alternative",
