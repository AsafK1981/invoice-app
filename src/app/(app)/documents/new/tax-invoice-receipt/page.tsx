...
export default function NewTaxInvoiceReceiptPage() {
  ...
  if (!canIssueTaxInvoices(business)) {
    return (
      <div className="card-soft p-12 text-center max-w-md mx-auto">
        ...
        <h2 className="font-bold text-stone-900 mb-2">חשבונית מס/קבלה זמינה רק לעוסק מורשה</h2>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-stone-700 mt-2 mr-14">
          שילוב חשבונית מס וקבלה במסמך אחד - מתאים כשהתשלום מתבצע מיד
        </p>
      </div>
