...
מבנה אחיד (/reports/uniform): קובץ OPENFORMAT לרשות המסים, נדרש מכל עסק שמנהל ספרים
בתוכנה - גם עוסק פטור. לא מגישים אותו ביוזמת העסק: מפיקים אותו כשמבקר מרשות המסים
