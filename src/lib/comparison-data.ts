...
export const COMPETITORS: Record<Competitor["slug"], Competitor> = {
  ...
  greeninvoice: {
    ...
    verdict:
      "חשבונית ירוקה חזקה אם אתה צריך API ואינטגרציות ומוכן לשלם ₪89-155 לחודש. אם אתה עצמאי שרוצה את כל הפיצ׳רים בלי הסיבוך — Pro ב-₪29 שלנו הוא פי 3 זול יותר ומספק את אותו הצורך.",
  },
  ifreelance: {
    slug: "ifreelance",
    name: "iFreelance",
