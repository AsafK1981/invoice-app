...
export const COMPETITORS: Record<Competitor["slug"], Competitor> = {
  ...
  greeninvoice: {
    ...
    ourStrengths: [
      ...
      "30 ימי ניסיון, ללא כרטיס אשראי — שקיפות מלאה לפני שמשלמים",
    ],
    verdict:
      "חשבונית ירוקה חזקה אם אתה צריך API ואינטגרציות ומוכן לשלם ₪89-155 לחודש. אם אתה עצמאי שרוצה את כל הפיצ׳רים בלי הסיבוך — Pro ב-₪25 שלנו הוא פי 3.5 זול יותר ומספק את אותו הצורך.",
  },
  ifreelance: {
    slug: "ifreelance",
    name: "iFreelance",
    ...
    theirStrengths: [
      ...
      "60 ימי ניסיון — פי 2 משלנו, ארוך משמעותית גם מהמתחרים",
  ...
  sumit: {
    ...
    verdict:
      "SUMIT מצוינת אם אתה רוצה אקוסיסטם רחב של חשבוניות, סליקה וגבייה ולהתחיל ממסלול חינם. אנחנו ממוקדים יותר ופשוטים יותר לעוסק — חינם עכשיו בהשקה, ואחר כך המחיר הזול והשקוף בקטגוריה, בלי לספור 'פעולות'.",
  },
  icount: {
    slug: "icount",
    name: "iCount",
    ...
    verdict:
      "iCount מערכת ותיקה, יציבה, עם עורף רו״ח חזק ו-45 ימי ניסיון. אם אתה רוצה כלי מהיר ונקי במחיר כניסה נמוך ובלי התחייבות שנתית — אנחנו חינם עכשיו בהשקה, ואחר כך מהזולים והשקופים בקטגוריה.",
  },
  ezcount: {
    slug: "ezcount",
    name: "EZcount",
    ...
    verdict:
      "EZcount מבית Hyp היא מהאפשרויות הזולות בשוק עם גב של חברת סליקה גדולה. אנחנו באותו טווח מחיר (וכרגע חינם בהשקה), עם ממשק מודרני יותר, PWA אמיתי ושליטה מלאה בנתונים — למי שרוצה חוויה נקייה ולא רק מחיר.",
  },
};
