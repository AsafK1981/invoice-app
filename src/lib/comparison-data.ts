    ...
    faq: [
      {
        ...
        a: `לפי דף המחירים של חשבונית ירוקה (נבדק 25.08.2026): Basic ${shekel("29")} לחודש עד 20 מסמכים, Best ${shekel("54")} לחודש (${shekel("45")} בחיוב שנתי) עד 50 מסמכים, Extra ${shekel("89")} לחודש (${shekel("74")} בחיוב שנתי) עד 200 מסמכים, ו-Prime ${shekel("155")} לחודש (${shekel("129")} בחיוב שנתי) עד 500 מסמכים. המחירים לפני מע\"מ. אין מסלול חינמי קבוע, רק תקופת ניסיון.`,
      },
      {
