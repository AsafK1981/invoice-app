...
const text = [
  ...
  ``,
  `שתי שאלות הסף כבר נענו בכתב (ספטמבר 2026): החיוב מתחיל רק עם טופס מסוף פרודקשן נפרד, וחיוב טוקן שמור עובד בלי מודול My Billing.`,
  `החיבור נבדק מקצה לקצה מול מסוף טסט ב-23.09.2026 והוא עובד, כולל חיוב חוזר. מה שנשאר: לפתוח מסוף פרודקשן, לבקש הצעת מחיר מעודכנת, ולהפוך את PAYMENT_PROVIDER ל-tranzila.`,
].join("\n");
